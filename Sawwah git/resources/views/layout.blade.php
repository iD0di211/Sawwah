...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/app.css') }}" style="width: 32px; height: 32px;">
...
<nav class="py-6 text-lg shadow-md bg-white navbar">
 
<section class="container">
<div class="logo">
  <img src="{{ asset('images/logo.png') }}" style="width:70px; height: 50px;">
</div>
...
<div id="search-container">
  ...
  <div id="main">
    ...
    <img id="icon-image" src="https://www.svgrepo.com/show/228009/worldwide-travel.svg" alt="icon" />
    <div id="search-icon">
      <svg stroke-linejoin="round" stroke-linecap="round" stroke-width="2" stroke="url(#cosmic-search)" fill="none" height="24" width="24" viewBox="0 0 24 24">
        ...
        <defs>
          <linearGradient gradientTransform="rotate(45)" id="cosmic-search">
            <stop stop-color="#73868a" offset="0%"></stop>
            <stop stop-color="#ab8a7a" offset="100%"></stop>
          </linearGradient>
        </defs>
      </svg>
    </div>
...
<ul class="menu">
    <li class="menu-list">
        <a href="{{ route( 'main') }}" class="menu-link">الرئيسية</a>
    </li>
    <li class="menu-list">
        <a href="{{ route('travel') }}" class="menu-link">أين أسافر؟</a>
    </li>
    <li class="menu-list">
        <a href="{{ route('contact') }}" class="menu-link">تواصل معنا</a>
    </li>
</ul>

<div class="btn-org">
  <button> <a href="{{ route('about') }}" class="menu-link">حسابي</a>
  <div class="icon-1">
